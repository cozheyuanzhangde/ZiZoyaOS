...
ld -m elf_i386 -s -o output/zizoya_kernel.bin -Ttext 0x1000 output/zizoya32_kernel_entry.o output/zizoya_kernel.o output/ports.o output/vga.o output/zizoya_util.o --oformat binary
