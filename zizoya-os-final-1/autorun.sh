...
ld -m elf_i386 -s -o output/zizoya_kernel.bin -Ttext 0x1000 output/zizoya32_kernel_entry.o output/zizoya_kernel.o output/ports.o output/vga.o output/idt.o output/isr.o output/interrupt.o output/timer.o output/keyboard.o output/memory.o output/string.o --oformat binary
