[bits 16]           ; 16-bit mode
[org 0x7c00]        ; 0x7c00 is the BIOS load memory location (this is a global offset because memory starts from here. If we don't add this, we need to add 0x7c00 everytime using memory location)
