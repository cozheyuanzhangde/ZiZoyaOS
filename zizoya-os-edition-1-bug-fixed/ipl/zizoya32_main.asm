...
KERNEL_OFFSET equ 0x7e00    ; kernel load memory offset
...
start:
    ...
    MSG_16bit_REALMODE_BOOTING db "ZiZoyaOS is booting in 16BIT-REAL-MODE...", 0
...
load_kernel:
    ...
    MSG_LOAD_ZizoyaKernel db "                                       ZiZoyaOS is loading the zizoya_kernel...", 0
